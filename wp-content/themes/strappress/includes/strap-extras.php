...
function bootstrap_styles()
{
	...
	wp_register_style( 'bootstrap-styles', get_template_directory_uri() .'/css/layouts/' . bi_option('bootswatch'), array(), '3.3.4', 'all' );
    ...
    wp_register_style( 'responsive-style', get_stylesheet_uri(), false, '3.3.4' );
